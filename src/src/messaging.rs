...
mod tests {
    ...
    #[test]
    fn pop_bytes_returns_empty_when_declared_length_exceeds_buffer() {
        let mut msg = Message::new(1, Priority::Highest, "test");
        msg.push_ulong(1000);
        ...
        assert_eq!(read_msg.pop_bytes(), Vec::<u8>::new());
    }

    #[test]
    fn pop_string_returns_empty_when_declared_byte_length_exceeds_buffer() {
        let mut msg = Message::new(1, Priority::Highest, "test");
        msg.push_ulong(50);
