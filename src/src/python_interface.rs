...
///
/// # Safety
/// Same preconditions as `PyUnicode_FromString`: caller holds `PYTHON_MUTEX` and the
/// GIL; `obj` is a valid NUL-terminated C string.
pub unsafe fn py_unicode_from_string(obj: *const c_char) -> *mut PyObject {
    #[cfg(test)]
